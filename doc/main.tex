...
\begin{usecase}
        ...
        \addscenario{Alternativni tokovi:}{
            \item[3.a] Korisnik odustaje od apliciranja za članstvo. Slučaj upotrebe se završava.
...
Na slici \ref{dtp_proizvodnja_prodaja} je prikazan dijagram toka podataka za slučaj upotrebe proizvodnja i prodaja, dok je na slici \ref{dslucup_proizvodnja_prodaja} prikazan dijagram slučaja upotrebe.
...
\begin{usecase}
        ...
        \addscenario{Alternativni tokovi:}{
            \item[6.a] Prozivođač ne potvrđuje da je uplata uspešno izvršena, i ulaže žalbu koja se šalje direktoru. Slučaj upotrebe se završava 
            
            \item[6.a] Prozivođač ne potvrđuje da je uplata uspešno izvršena. Slučaj upotrebe se izvršava.
...
Na slici \ref{dtp_kupovina} je prikazan dijagram toka podataka za slučaj kupovina.
\begin{figure}[h!]
    \centering
...
\subsection{Ostalo}
Na slici \ref{dtp_ostalo} je prikazan dijagram toka podataka za slučaj ostalo.
\begin{figure}[h!]
    \centering
